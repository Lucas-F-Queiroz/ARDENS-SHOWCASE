...
More details: docs/AI-WORKFLOW.md
...
assets/screenshots/before.png

assets/screenshots/after.png
...
MVP first — validate the loop before spending heavily on polish.

Refactor after evidence — restructure code when real usage exposes friction, not only because a pattern looks cleaner.

Keep presentation separate from rules when practical — UI should display game state rather than become the source of truth.

Prefer understandable systems over premature complexity.

Use AI as leverage, not as an authority — suggestions still require context, review and testing.

Roadmap

Current priorities:

Reach a functional MVP

Validate the main gameplay loop
...
GitHub: Lucas-F-Queiroz

LinkedIn: lucas-queiroz-54a21b233
